...
This is a classic two-pointer problem laced with some book-keeping. The choice for the data structure is the one that can map character to its
previous occurance index, quite naturally a hashmap/dictionary
