...
'''
Find out the places to be filled. Backtrack/dfs on the places to find a combination that leaves all places filled
Time complexity: O(1) because we might visit all cells?
Space Complexity: O(1) since we can store all cells in the array which is 81
'''
